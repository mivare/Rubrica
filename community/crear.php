...
<input class="btn btn-success" type="button" onclick="agregarPreguntaRubrica()" value="Agregar pregunta"/> <input class="btn btn-danger" type="button" onclick="eliminarPreguntasRubrica()" value="Eliminar todas las preguntas"/><br><br>
